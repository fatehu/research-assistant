...
def downgrade() -> None:
    op.drop_index("ix_agent_memory_items_scope_id", table_name="agent_memory_items")
    op.drop_index("ix_agent_memory_items_scope_type", table_name="agent_memory_items")
    op.drop_index("ix_agent_memory_items_channel", table_name="agent_memory_items")
    op.drop_index("ix_agent_memory_items_user_id", table_name="agent_memory_items")
    op.drop_table("agent_memory_items")

    op.drop_index("ix_conversation_summaries_up_to_message_id", table_name="conversation_summaries")
    op.drop_index("ix_conversation_summaries_conversation_id", table_name="conversation_summaries")
    op.drop_index("ix_conversation_summaries_id", table_name="conversation_summaries")
    ...
    op.drop_index("ix_agent_runs_notebook_id", table_name="agent_runs")
