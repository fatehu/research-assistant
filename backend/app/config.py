...
class Settings(BaseSettings):
    ...
    openalex_email: str = ""
    crossref_email: str = ""
    literature_search_default_source: str = "auto"
    literature_search_auto_source_order: str = "openalex,semantic_scholar,arxiv,pubmed,crossref"
    literature_search_multi_source_order: str = "openalex,semantic_scholar,arxiv,pubmed"
    literature_search_provider_timeout_seconds: int = 20
    literature_search_provider_retry_attempts: int = 2
    literature_search_retry_backoff_seconds: float = 1.0
    literature_search_semantic_scholar_min_interval_seconds: float = 1.0
    literature_search_semantic_scholar_public_min_interval_seconds: float = 3.0
    literature_search_arxiv_min_interval_seconds: float = 3.0
    literature_search_pubmed_min_interval_seconds: float = 0.34
    literature_search_pubmed_api_key_min_interval_seconds: float = 0.12
    literature_search_openalex_min_interval_seconds: float = 0.12
    literature_search_crossref_min_interval_seconds: float = 0.25
    ...
    agent_mid_run_compaction_enabled: bool = True
    agent_mid_run_compaction_min_iteration: int = 2
    agent_mid_run_compaction_max_per_run: int = 2
    agent_mid_run_compaction_message_tokens_trigger: int = 6000
    agent_context_state_enabled: bool = True
